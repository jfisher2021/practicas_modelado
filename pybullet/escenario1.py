...
try:
     ...
     while True:
          ...
          pos_y = posRobot[1]
          p.setJointMotorControlArray(terreneitor, [2, 3, 4, 5], p.VELOCITY_CONTROL, targetVelocities=[10, 10, 10, 10], forces=[30, 30, 30, 30])
          ...
          if distance >= 0.01:  # Si se ha movido al menos 0.01 metros
               ...
               data.append([time.time(), pos_y, velRobot[1], wheel_velocities, wheel_forces])
